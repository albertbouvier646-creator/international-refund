              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.caseType} onValueChange={(value) => setFormData({...formData, caseType: value})}>
                    <SelectTrigger>
                      <SelectValue placeholder={t('case_placeholder')} />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="crypto">{t('case_crypto')}</SelectItem>
                      <SelectItem value="investment">{t('case_investment')}</SelectItem>
                      <SelectItem value="insurance">{t('case_insurance')}</SelectItem>
                      <SelectItem value="corporate">{t('case_corporate')}</SelectItem>
                      <SelectItem value="bank">{t('case_bank')}</SelectItem>
                      <SelectItem value="international">{t('case_international')}</SelectItem>
                      <SelectItem value="other">{t('case_other')}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
